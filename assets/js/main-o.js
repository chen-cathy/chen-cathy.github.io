    ...
    function renderReports(reports) {
        ...
        reports.forEach(report => {
            ...
            if (isAILab) {
                ...
                icon = 'fa-microchip';
                buttonHTML = `
                    <a href="${report.file}" class="btn-workflow">
                ...
                buttonHTML = `
                    <div class="dual-btn-container">
                        <a href="${report.pdf_link || '#'}" class="btn-original">
                            <i class="fa-regular fa-file-pdf"></i> Original Research
                        </a>
                        <a href="${report.file || '#'}" class="btn-interactive">
                ...
                icon = 'fa-user';
                buttonHTML = `
                    <a href="${report.file || '#'}" class="btn-primary" style="width:100%; justify-content:center;">
                        View Profile
                    </a>
                `;
            }
